...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field admins on 'FriendGroup'
        db.create_table('profiles_friendgroup_admins', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('friendgroup', models.ForeignKey(orm['profiles.friendgroup'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('profiles_friendgroup_admins', ['friendgroup_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field admins on 'FriendGroup'
        db.delete_table('profiles_friendgroup_admins')
